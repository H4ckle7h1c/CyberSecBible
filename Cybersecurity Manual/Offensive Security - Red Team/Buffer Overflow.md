SOURCE : https://github.com/Tib3rius/Pentest-Cheatsheets/blob/master/exploits/buffer-overflows.rst
...
```
But this does not cover the spikking with is the fact to find the vulnerable parameter.
################
Buffer Overflows
################
